...
hobbyist or researcher with a limited budget.  The devlopment of 3D printers, Bluetooth, microprocessors
...
may contact a 2'' diamter steel ball.  This provides a pull force greater than the 50 Newton force applied by our linear
...
Although this joint functions well and acheives the intetion of making the robot quick to assemble and disassemble for travel,
it is broken by side forces. Since climbing over obstacles and stairs will necessarily involved side forces on the actuators,
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.8\textwidth]{5TetGlussBotPictures/DSC_0002.jpg}
...
Nonetheless as mentioned in future steps the current software is specific to either the 3-tetrahedron geometry or the 5-tet geometry.
...
We believe the 3TetGlussBot is the simplest amount of gluss that we thought would be capable of locomtion.
We believe that by adding even more gluss, that is, by connectiong more tetrahedra in the tetrahelix,
...
A quadripedal robot was constructed completely out of the tetrahedral/octahedral geometry.
...
It has been reasonable to produce a static gait for the 3TetGlussBot because its behavior is not
...
\item [Quick Joint:] (Mechanical Engineering) If all of the turret joints in a 3TetGlussBot are dissassembled so that
...
since spreads are non-linear, we cannot use \textit{Delta Defintion},  or \textit{acute bump} in their
