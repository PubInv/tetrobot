...
Other geometries, such as moving planes, are possibile with the same material.
...
The Octet Truss reflects the geomtry called the \emph{cuboctahedron}.
...
Although this joint functions well and easily achieves the intetion of making the robot quick to assemble and disassemble for travel,
...
We believe the 3TetGlussBot is the simplest amount of gluss that would be capable of locomtion.
