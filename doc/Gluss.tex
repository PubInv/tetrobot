...
\begin{abstract}
  ...
  spaceframe or truss composed only of joints and linear actuators with a new 3D-printable emodiment of a
  ...
  inexpensive open-source modules comprising an Arduino Mega, a custom PCB, servo controller chipes, and a Bluetooth module.
