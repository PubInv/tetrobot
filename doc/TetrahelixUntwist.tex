...
\begin{conjecture}
  The tetrahelices generated by $H_{continum}$ are optimal in terms of minimum maximum member length, minimum total member length, and minimum
