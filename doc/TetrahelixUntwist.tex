...
\begin{abstract}
  ...
  axis.  The three irregular tetrahedra stack together to form an oblque equilateral prism with parallel base faces.
\end{abstract}
...
\secton{About the Equitetrabeam}
...
Idea: we can smoothly integrate between the tetrahelix and the tetrabeam by a linear combination of node lengths.
...
https://patents.google.com/patent/US20030041548A1/en?q=equilateral&q=truss&q=beam
