...
However, a tetrahelix does not rest on a plane in a simple way. It is convenient to be able to ``untwist'' and form a spaceframe that
...
We propse that the interior members be colored based on the rails they connect using an subtractive color scheme, or orange, purple, and green,
...
formed are sufficient to untwist the tetrahelix and for our purposes: $red, yellow, orange_{even}, orange_o, purple_e, purple_o, green_e, green_o$. In the diagram below, the ``odd'' members are draw with a dashed line.
 ...
 We further assume the red, yellow and blue members are all of unit length. The alitude of an equilateral triangle is $\sqrt{3}/2$.
